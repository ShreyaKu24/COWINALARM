...
{
    let endpoint = relativePath + './district.json'
...
// Read below javascript  for project
// map
// arrow function


// function getName(employee){  - normal function syntax
//     return employee.name;
// }

// const getName = (employee) => employee.name;  - arrow function syntax
